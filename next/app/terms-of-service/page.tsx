            ...
            <div className='bg-white rounded-lg shadow-md p-6 sm:p-8 mt-2'>
              <div className="space-y-6 text-gray-700">
                <div>
                  ...
                  <p className="mb-4">
                    この利用規約（以下「本規約」）は、プレリビ（以下「当サービス」）の利用条件を定めるものです。ユーザーの皆様には、本規約に同意いただいた上で当サービスをご利用いただきます。
                  </p>
                </div>
                ...
                <section>
                  ...
                  <ul className="list-decimal list-inside ml-4 space-y-2">
                    ...
                    <li>当サービスは本規約のほか、ご利用にあたってのルール等、各種の定め（以下「個別規定」）をすることがあります。これら個別規定はその名称のいかんに関わらず、本規約の一部を構成するものとします。</li>
                ...
                <section>
                  ...
                  <ul className="list-decimal list-inside ml-4 space-y-2">
                    ...
                    <li>ユーザーIDおよびパスワードが第三者によって使用されたことによって生じた損害は、当サービスに故意又は重大な過失がある場合を除き、当サービスは一切の責任を負わないものとします。</li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  <ul className="list-decimal list-inside ml-4 space-y-2">
                    ...
                    <li>虚偽の情報や誤解を招く情報を投稿する行為</li>
                    <li>同一または類似の内容を繰り返し投稿する行為（スパム行為）</li>
                ...
                <section>
                  <h2 className="text-2xl font-semibold text-gray-900 mb-4">第8条（保証の否認および免責事項）</h2>
                  <ul className="list-decimal list-inside ml-4 space-y-2">
